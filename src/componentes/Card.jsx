    ...
    <div className='relative flex justify-center'>
        <div className="w-[100%] lg:w-[350px] lg:fixed bg-white text-black p-3 exm:p-6 rounded-3xl relative">
            ...
            <div className="flex items-center justify-center mb-6">
                <span className="bg-naranja text-white px-3 py-1 rounded-full text-sm">Programador</span>
            </div>
            ...
            <div className="flex gap-4 justify-center items-center mb-6">
                <a href="https://www.linkedin.com/in/santiago-rodrigo-deza-chest-44638817b" target='_blank' className="text-naranja ">
                    <TiSocialLinkedin className="w-6 h-6" />
                </a>
                <a href="https://github.com/Santiago290"  target='_blank'  className="text-naranja ">
